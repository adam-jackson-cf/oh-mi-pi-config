...
First, delegate an independent alternative analysis to `innovation-fable`. Then
synthesize both analyses; resolve disagreements using repository evidence and

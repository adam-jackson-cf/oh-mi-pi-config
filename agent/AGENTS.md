...
Base path: `~/.agents/by-request/`

NEVER read a skill unless its `Use when` applies; when it applies, MUST read it
before acting.

| Use when | Path |
| --- | --- |
| `adaptive-prose` requested | `adaptive-prose/SKILL.md` |
| `analyze-agentic-readiness` requested | `analyze-agentic-readiness/SKILL.md` |
| `analyze-architecture` requested | `analyze-architecture/SKILL.md` |
| `analyze-code-integrity` requested | `analyze-code-integrity/SKILL.md` |
| `analyze-code-quality` requested | `analyze-code-quality/SKILL.md` |
| `analyze-performance` requested | `analyze-performance/SKILL.md` |
| `analyze-root-cause` requested | `analyze-root-cause/SKILL.md` |
| `analyze-security` requested | `analyze-security/SKILL.md` |
| `clawpatch` requested | `clawpatch/SKILL.md` |
| Assessing a plan for codebase inertia | `codebase-inertia-review/SKILL.md` |
| `codify-agent-trace` requested | `codify-agent-trace/SKILL.md` |
| `codify-git-history` requested | `codify-git-history/SKILL.md` |
| `codify-pr-reviews` requested | `codify-pr-reviews/SKILL.md` |
| Reusable agent or subagent spec needed | `create-agent/SKILL.md` |
| Durable goal needs defining or maintaining | `create-goal/SKILL.md` |
| `create-hand-off` requested | `create-hand-off/SKILL.md` |
| Agent skill needs creating or updating | `create-skill/SKILL.md` |
| `deep-interview` requested | `deep-interview/SKILL.md` |
| `deep-topic-research` requested | `deep-topic-research/SKILL.md` |
| Local Docker or OrbStack actions required | `docker-orbstack/SKILL.md` |
| `docs-site-setup` requested | `docs-site-setup/SKILL.md` |
| `get-codebase-primer` requested | `get-codebase-primer/SKILL.md` |
| `get-recent-context` requested | `get-recent-context/SKILL.md` |
| Any Git action is required | `git-tool/SKILL.md` |
| Managing local secrets or `.env` files | `infisical-secrets-hygiene/SKILL.md` |
| `intent-plan` requested | `intent-plan/SKILL.md` |
| Installing macOS tools without repo guidance | `macos-package-install-defaults/SKILL.md` |
| `omp-homebrew-updates` requested | `omp-homebrew-updates/SKILL.md` |
| Operating Orca-managed state or Orca CLI | `orca-cli/SKILL.md` |
| Executing a supplied plan via orchestration | `orchestrate/SKILL.md` |
| `paperclip` requested | `paperclip/SKILL.md` |
| `plan-solution` requested | `plan-solution/SKILL.md` |
| Assessing a prospective UK employer | `prospective-employer-diligence/SKILL.md` |
| Visual explanation or diagram requested | `show-me/SKILL.md` |
| Operating local SigNoz telemetry | `signoz-telemetry/SKILL.md` |
| `setup-code-precommit-checks` requested | `setup-code-precommit-checks/SKILL.md` |
| `setup-dev-monitoring` requested | `setup-dev-monitoring/SKILL.md` |
| `setup-package-monitoring` requested | `setup-package-monitoring/SKILL.md` |
| `--tmux` or persistent terminal work needed | `tmux-tool/SKILL.md` |
